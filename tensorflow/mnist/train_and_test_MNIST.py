...
tf.flags.DEFINE_integer("num_epochs", 50, "Number of training epochs (default: 2000)")
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        # Train Summaries
        train_summary_op = tf.merge_summary([loss_summary, acc_summary, image_summary_op, grad_summaries_merged])
